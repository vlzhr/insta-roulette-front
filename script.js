...
function run () {
    ...
    document.documentElement.style.setProperty('--spin', 3240 + 3510 - 360*(+items_n/items.length) + "deg", "important");
    document.querySelector("#roulette").classList.add("spinning");

    window.setTimeout(function () { document.querySelectorAll(".item")[items_n].classList.add("wins") }, interval*1000+1000)
}
